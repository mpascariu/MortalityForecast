...
#' @return An object of class \code{"fitMRandomWalk"} with components:
...
#' @export
fitMRandomWalk <- function(data, x = NULL, y = NULL, include.drift = TRUE, ...) {
  # Save the input
  ...
  out <- structure(class = "fitMRandomWalk", out)  
  return(out)
}
...
#' @param object An object of class \code{\link{fitMRandomWalk}}.
#' @param ... Further arguments passed to or from other methods.
#' @seealso \code{\link{fitMRandomWalk}}
#' @export
residuals.fitMRandomWalk <- function(object, ...) {
  structure(class = "residMF", as.matrix(object$residuals))
}


#' Print function for fitMRandomWalk method
#' @param x An object of class \code{\link{fitMRandomWalk}}.
#' @inheritParams residuals.fitMRandomWalk
#' @keywords internal
#' @export
print.fitMRandomWalk <- function(x, ...) {
